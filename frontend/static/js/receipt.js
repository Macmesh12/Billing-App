/* ============================================
   ...
   - Real-time calculation of totals and balances
...
(function () {
    ...
    // ============================================
    const state = {
        receiptId: null,                    // Current receipt ID (null for new receipts)
        receiptNumber: "REC-NEW",          // Receipt number (generated by server)
        receiptNumberReserved: false,      // Whether the number is reserved in Firebase
    ...
    /**
     * Updates the receipt number in the UI and state
     * @param {string} value - The receipt number to set
     * @param {object} options - Options including whether number is reserved
     */
    ...
    /**
     * Reserves a receipt number from the server (Firebase counter)
     * This prevents duplicate receipt numbers across sessions
     * @returns {object} Object with number, reserved status, and optional error
     */
     ...
     * @param {string} tone - Toast style: "success", "error", "info"
     */
